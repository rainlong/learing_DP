...
- [行为型](./example/BEHAVIORAL/ "")
  - ChainOfResponsibility - [*职责链模式*](./example/BEHAVIORAL/ "查看职责链模式的说明")
  - Command - [*命令模式*](./example/BEHAVIORAL/ "查看模式的说明")
  - Interpreter - [*解释器模式*](./example/BEHAVIORAL/ "查看解释器模式的说明")
  - Iterator - [*迭代器模式*](./example/BEHAVIORAL/ "查看迭代器模式的说明")
  - Mediator - [*中介者模式*](./example/BEHAVIORAL/ "查看中介者模式的说明")
  - Mementor - [*备忘录模式*](./example/BEHAVIORAL/ "查看备忘录模式的说明")
  - Observer - [*观察者模式*](./example/BEHAVIORAL/ "查看观察者模式的说明")
  - State - [*状态模式*](./example/BEHAVIORAL/ "查看状态模式的说明")
  - Strategy - [*策略模式*](./example/BEHAVIORAL/ "查看策略模式的说明")
  - Template - [*模板模式*](./example/BEHAVIORAL/ "查看模板模式的说明")
  - Visitor - [*访问者模式*](./example/BEHAVIORAL/ "查看访问者模式的说明")
